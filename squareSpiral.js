...
// // // f we divide the matrix into two parts – upper right triangle (marked by red) and lower left triangle (marked by blue), as shown above, then using marker x we can easily calculate the value that will be present at index (i, j) in any N × N spiral matrix with the following formula:
